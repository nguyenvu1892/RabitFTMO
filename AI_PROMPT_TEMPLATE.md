...
Bất cứ khi nào ngươi hoàn thành một thay đổi trên dự án, hoặc thực hiện một hoạt động code/fix bug nào, ngươi BẮT BUỘC phải trình bày báo cáo ra khung chat theo đúng định dạng chính xác sau đây:
